...
<div class="bg-white shadow-md rounded px-8 pt-24 pb-8 mb-30"> 
    <h2 class="text-3xl font-semibold mb-4 text-center">Actualizacion de servicios</h2>
    <div class="custom-form-width mx-auto mb-20">
        <form method="POST" action="{{ route('services.update', ['service_name' => $service->service_name]) }}" enctype="multipart/form-data" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
            ...
            <div class="mb-4">
                <label for="service_description" class="block text-gray-700 text-sm font-bold mb-2">Descripción:</label>
            ...
            <div class="mb-4">
                <label for="current_image" class="block text-gray-700 text-sm font-bold mb-2">Imagen actual:</label>
                <div class="mb-2">
                    <img src="{{ asset('images/' . $service->image_path) }}" alt="{{ $service->service_name }}" class="max-w-xs rounded shadow-md">
                </div>
                <label for="image" class="block text-gray-700 text-sm font-bold mb-2">Actualizar imagen:</label>
            ...
            <div class="flex items-center justify-center">
                <button type="submit" class="btn-pink">Servicio de Actualización</button>
            </div>
        </form>
    </div>
</div>
